...
public class GUIEditarCuerda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Instrumento de Cuerda");
    ...
    try {
        ...
        if (inst != null && inst instanceof InstrumentoCuerda) {
            ...
            lblId1.setText(String.valueOf(cuerda.getId()));
            ...
            txtNumeroLlaves.setText(String.valueOf(cuerda.getNumeroCuerdas())); 
            txtTipoBoquilla.setText(String.valueOf(cuerda.getNumeroTrastes())); 
            ...
            // Limpiar los campos 
            lblId1.setText(""); txtNombre.setText(""); txtFechaVenta.setText("");
    ...
    try {
        ...
        int idNuevo = Integer.parseInt(lblId1.getText().trim());
        String nombre = txtNombre.getText().trim();
        LocalDate fecha = LocalDate.parse(txtFechaVenta.getText().trim()); // Formato YYYY-MM-DD
        double precio = Double.parseDouble(txtPrecio.getText().trim());
        int cuerdas = Integer.parseInt(txtNumeroLlaves.getText().trim());
        int trastes = Integer.parseInt(txtTipoBoquilla.getText().trim());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIEditarCuerda().setVisible(true));
    }
