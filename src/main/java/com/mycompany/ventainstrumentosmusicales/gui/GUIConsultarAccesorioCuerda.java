 ...
 * @author User
 */
public class GUIConsultarAccesorioCuerda extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIConsultarAccesorioCuerda.class.getName());
     ...
     */
    public GUIConsultarAccesorioCuerda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblIdInstrumento = new javax.swing.JLabel();
        ...
        jLabel3.setText("Consultar Accesorio de Cuerda");
        ...
        jLabel10.setText("ID Instrumento");
        ...
        lblTipo.setText("Aun no encontrada");

        lblPrecio.setForeground(new java.awt.Color(255, 255, 255));
        lblPrecio.setText("Aun no encontrada");

        lblMarca.setForeground(new java.awt.Color(255, 255, 255));
        lblMarca.setText("Aun no encontrada");

        lblIdInstrumento.setForeground(new java.awt.Color(255, 255, 255));
        lblIdInstrumento.setText("Aun no encontrada");
    ...
    try {
        ...
        if (accesorio != null) {
            ...
            lblNombre1.setText(accesorio.getNombre());
            lblTipo.setText(String.valueOf(accesorio.getTipo()));
            lblPrecio.setText(String.valueOf(accesorio.getPrecio()));
            lblMarca.setText(accesorio.getMarca());
            lblIdInstrumento.setText(String.valueOf(accesorio.getIdInstrumento()));
            ...
            // Limpiar los campos 
            lblId2.setText(""); lblNombre1.setText(""); lblTipo.setText("");
            lblPrecio.setText(""); lblMarca.setText(""); lblIdInstrumento.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIConsultarAccesorioCuerda().setVisible(true));
    }
    ...
    private javax.swing.JLabel lblIdInstrumento;
